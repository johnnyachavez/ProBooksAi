...
def _bank_import_keyboard_shortcuts_help_text() -> str:
    ...
    return (
        ...
        "(tab-separated text) or **Keyboard shortcuts…**; on empty area, shortcuts only. "
        "**Export comparison CSV\u2026** saves the current grid to UTF-8 CSV (numeric amounts; "
        "**Reconciled** yes/no matches the checkboxes).\n\n"
