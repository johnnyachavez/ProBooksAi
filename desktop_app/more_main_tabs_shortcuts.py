...
def more_main_tabs_keyboard_shortcuts_help_text() -> str:
    return (
        ...
        "Reports — F5 re-runs the last report you opened (trial balance, P&L, balance sheet, or an AR/AP list), "
        "if any.\n"
        ...
        "or **Open linked Business record…** when that row has a **complete bank link** "
        "(**Customers** / **Vendors** / **More → Business → Payroll**). "
        ...
        "File → Backup company file… / Restore from backup… uses probooks.backup.\n"
        ...
        "**Link payment…** also offers **Open linked Business record…** when the stored link is complete.\n"
