...
- **ROADMAP Supporting / cross-cutting** — **`docs/ROADMAP.md`** defines **`<a id="supporting-cross-cutting-issues"></a>`** before **`## Supporting / Cross-cutting Issues`**; **BACKLOG**, **issues-backlog**, this page **Other docs**, and **`review.html`** Documentation cards (local **`docs/ROADMAP.md#supporting-cross-cutting-issues`** + **GitHub blob** same fragment) include that link — **`test_hub_docs_link_roadmap_supporting_cross_cutting_issues`**.
