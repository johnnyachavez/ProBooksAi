...
- **Add transaction…** (**Tools** → **Register Actions**) opens a dialog (date, signed amount, description, ref, memo) and inserts into `bank_transactions` with the same sign convention as CSV import (positive = inflow, negative = outflow).
